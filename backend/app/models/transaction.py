...
"""
Core reconciliation models: BankAccount, Reconciliation, BankTransaction,
LedgerTransaction, Match, Anomaly.
"""
...
class BankTransaction(Base):
    ...
    # If later you want per-transaction links from Match, you can add:
...
class LedgerTransaction(Base):
    ...
    # Similarly, you could add a matches relationship here if you later normalize
...
class Match(Base):
    ...
    # Stored as comma-separated IDs for now (simple, matches your design).
    bank_transaction_ids = Column(String(500), nullable=False)   # e.g. "1,2,3"
    ledger_transaction_ids = Column(String(500), nullable=False)  # e.g. "10,11"

    match_type = Column(String(50), default="exact")  # exact, fuzzy, manual, etc.
...
class Anomaly(Base):
    ...
    # You could also relate resolver user if you have a User model relationship
